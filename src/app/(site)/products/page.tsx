  ...
  return (
    <main className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-4 py-10 sm:px-6 lg:px-8">
      <header className="space-y-2 text-center">
        <h1 className="text-4xl font-semibold tracking-tight text-neutral-900">Nuestro catálogo</h1>
        <p className="text-sm text-neutral-600">
          Descubrí las novedades, filtrá por tus categorías favoritas y encontrá lo que buscás en
          segundos.
        </p>
      </header>
